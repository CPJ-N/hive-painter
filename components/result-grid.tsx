        ...
        return (
          <div key={group.runId} className={index === 0 ? "" : "mt-8"}>
            <div className="mb-4 flex items-center gap-3">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent via-gray-100/15 to-gray-100/10" />
              ...
              <div className="h-px flex-1 bg-gradient-to-l from-transparent via-gray-100/15 to-gray-100/10" />
            </div>
